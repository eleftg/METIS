...
--------------------------------------------------------------------------*/
// in this Frankenstein version of metis with both integer sizes linked
// in simultaneously, the best way to control the index size is to
// define the IDXTYPEWIDTH macro by means of a command-line flag
// (e.g. -DIDXTYPEWIDTH=32 or /DIDXTYPEWIDTH=64).
...
#if IDXTYPEWIDTH == 64
#define METIS_PartGraphRecursive METIS64_PartGraphRecursive
#define METIS_PartGraphKway METIS64_PartGraphKway
#define METIS_MeshToDual METIS64_MeshToDual
#define METIS_MeshToNodal METIS64_MeshToNodal
#define METIS_PartMeshNodal METIS64_PartMeshNodal
#define METIS_PartMeshDual METIS64_PartMeshDual
#define METIS_NodeND METIS64_NodeND
#define METIS_Free METIS64_Free
#define METIS_SetDefaultOptions METIS64_SetDefaultOptions
#define METIS_NodeNDP METIS64_NodeNDP
#define METIS_ComputeVertexSeparator METIS64_ComputeVertexSeparator
#define METIS_NodeRefine METIS64_NodeRefine
#endif
